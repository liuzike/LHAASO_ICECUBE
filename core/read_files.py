...
#Importing Aeff data
        ...
        print("read mspdata")
        #IMPORT LHSAAODATA
        lhassodata1=pd.read_csv(master_path + "lhsaaocataloguekm2a.csv")
        lhassodata2=pd.read_csv(master_path + "lhsaaocataloguewcda.csv")
        self.lhassodata1=lhassodata1
        self.lhassodata2=lhassodata2
