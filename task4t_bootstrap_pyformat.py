...
for cyc in prange(n_cyc):
    ...
    # if os.path.isfile(altier_path[0] + f'all_Si_ws_g_s_{len(enus)}_{len(enus)}_bins_C_wt_all_psr_wmod1__btsp3_cyc_{cyc}.pkl'):
    #     print("Loading all_Si_ws_g_s from pickle")
    #     with open(altier_path[0] + f'all_Si_ws_g_s_{len(enus)}_{len(enus)}_bins_C_wt_all_psr_wmod1__btsp3_cyc_{cyc}.pkl', 'rb') as f:
    ...
    print("Calculated S_i for all neutrinos and gammas and weighting schemes")
        #Save to pickle
    with open(altier_path[0] + f'all_Si_ws_g_s_{len(enus)}_{len(enus)}_bins_C_wt_all_psr_wmod1__btsp3_cyc_{cyc}.pkl', 'wb') as f:
    ...
    #Pickle
    arr = []
    # if os.path.isfile(altier_path[0] + f'ns_all_ws_{len(enus)}_{len(enus)}_bins_C_wt_all_psr_wmod1__btsp3_cyc_{cyc}.pkl'):
    #     print("Loading ns_hat from pickle...")
    #     with open(altier_path[0] + f'ns_all_ws_{len(enus)}_{len(enus)}_bins_C_wt_all_psr_wmod1__btsp3_cyc_{cyc}.pkl', 'rb') as f:
    #         arr = pickle.load(f)
    ...
    with open(altier_path[0] + f'ns_all_ws_{len(enus)}_{len(enus)}_bins_C_wt_all_psr_wmod1__btsp3_cyc_{cyc}.pkl', 'wb') as f:
        pickle.dump(arr, f)
    ...
    with open(altier_path[0] + f'all_TSS_{len(enus)}_{len(enus)}_bins_C_wt_all_psr_wmod1__btsp3_cyc_{cyc}.pkl', 'wb') as f:
